...
insert into _Forum (Name) values ('First Forum');
insert into _Forum (Name) values ('Second Forum');
...
insert into _User values ('Mandaaaaas','BOSS',MD5('qweasd'),'','Admin');
insert into _Subforum (Name,Description,ForumId) values ('First Subforum','test',1);
insert into _Subforum (Name,Description,ForumId) values ('Second Subforum','test',1);
insert into _Theme (Name,Description,Creator,SubforumId) values ('Heroes','about','Mandaaaaas',1);
insert into _Message (_Text,_Date,Creator,ThemeId) values ('ghfdssdwerthyhfd',now(),'Mandaaaaas',1);
